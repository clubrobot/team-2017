...
class WheeledBase(SerialTalksProxy):
	...
	def __init__(self, parent, uuid='wheeledbase'):
		...
		self.leftwheel = WheeledBase.Namespace()
		self.leftwheel.radius   = WheeledBase.Parameter(self, LEFTCODEWHEEL_RADIUS_ID, FLOAT)
		self.leftwheel.constant = WheeledBase.Parameter(self, LEFTWHEEL_CONSTANT_ID, FLOAT)
		self.leftwheel.maxPWM   = WheeledBase.Parameter(self, LEFTWHEEL_MAXPWM_ID, FLOAT)

		self.rightwheel = WheeledBase.Namespace()
		self.rightwheel.radius   = WheeledBase.Parameter(self, RIGHTWHEEL_RADIUS_ID, FLOAT)
		self.rightwheel.constant = WheeledBase.Parameter(self, RIGHTWHEEL_CONSTANT_ID, FLOAT)
		self.rightwheel.maxPWM   = WheeledBase.Parameter(self, RIGHTWHEEL_MAXPWM_ID, FLOAT)

		self.leftcodewheel = WheeledBase.Namespace()
		self.leftcodewheel.radius       = WheeledBase.Parameter(self, LEFTCODEWHEEL_RADIUS_ID, FLOAT)
		self.leftcodewheel.countsperrev = WheeledBase.Parameter(self, LEFTCODEWHEEL_COUNTSPERREV_ID, LONG)

		self.rightcodewheel = WheeledBase.Namespace()
		self.rightcodewheel.radius       = WheeledBase.Parameter(self, RIGHTCODEWHEEL_RADIUS_ID, FLOAT)
		self.rightcodewheel.countsperrev = WheeledBase.Parameter(self, RIGHTCODEWHEEL_COUNTSPERREV_ID, LONG)

		self.odometry = WheeledBase.Namespace()
		self.odometry = WheeledBase.Parameter(self, ODOMETRY_AXLETRACK_ID, FLOAT)
		self.odometry = WheeledBase.Parameter(self, ODOMETRY_SLIPPAGE_ID, FLOAT)

		self.velocitycontrol = WheeledBase.Namespace()
		self.velocitycontrol.axletrack = WheeledBase.Parameter(self, VELOCITYCONTROL_AXLETRACK_ID, FLOAT)
		self.velocitycontrol.maxlinacc = WheeledBase.Parameter(self, VELOCITYCONTROL_MAXLINACC_ID, FLOAT)
		self.velocitycontrol.maxlindec = WheeledBase.Parameter(self, VELOCITYCONTROL_MAXLINDEC_ID, FLOAT)
		self.velocitycontrol.maxangacc = WheeledBase.Parameter(self, VELOCITYCONTROL_MAXANGACC_ID, FLOAT)
		self.velocitycontrol.maxangdec = WheeledBase.Parameter(self, VELOCITYCONTROL_MAXANGDEC_ID, FLOAT)
		
		self.linvelPID = WheeledBase.Namespace()
		self.linvelPID.KP        = WheeledBase.Parameter(self, LINVELPID_KP_ID, FLOAT)
		self.linvelPID.KI        = WheeledBase.Parameter(self, LINVELPID_KI_ID, FLOAT)
		self.linvelPID.KD        = WheeledBase.Parameter(self, LINVELPID_KD_ID, FLOAT)
		self.linvelPID.minoutput = WheeledBase.Parameter(self, LINVELPID_MINOUTPUT_ID, FLOAT)
		self.linvelPID.maxoutput = WheeledBase.Parameter(self, LINVELPID_MAXOUTPUT_ID, FLOAT)
		
		self.angvelPID = WheeledBase.Namespace()
		self.angvelPID.KP        = WheeledBase.Parameter(self, ANGVELPID_KP_ID, FLOAT)
		self.angvelPID.KI        = WheeledBase.Parameter(self, ANGVELPID_KI_ID, FLOAT)
		self.angvelPID.KD        = WheeledBase.Parameter(self, ANGVELPID_KD_ID, FLOAT)
		self.angvelPID.minoutput = WheeledBase.Parameter(self, ANGVELPID_MINOUTPUT_ID, FLOAT)
		self.angvelPID.maxoutput = WheeledBase.Parameter(self, ANGVELPID_MAXOUTPUT_ID, FLOAT)

		self.positioncontrol = WheeledBase.Namespace()
		self.positioncontrol.linvelKP  = WheeledBase.Parameter(self, POSITIONCONTROL_LINVELKP_ID, FLOAT)
		self.positioncontrol.angvelKP  = WheeledBase.Parameter(self, POSITIONCONTROL_ANGVELKP_ID, FLOAT)
		self.positioncontrol.linvelmax = WheeledBase.Parameter(self, POSITIONCONTROL_LINVELMAX_ID, FLOAT)
		self.positioncontrol.angvelmax = WheeledBase.Parameter(self, POSITIONCONTROL_ANGVELMAX_ID, FLOAT)
		self.positioncontrol.linposthr = WheeledBase.Parameter(self, POSITIONCONTROL_LINPOSTHRESHOLD_ID, FLOAT)
		self.positioncontrol.angposthr = WheeledBase.Parameter(self, POSITIONCONTROL_ANGPOSTHRESHOLD_ID, FLOAT)
		
		self.purepursuit = WheeledBase.Namespace()
		self.purepursuit.lookahead = WheeledBase.Parameter(self, PUREPURSUIT_LOOKAHEAD_ID, FLOAT)
